...
figure
subplot(4,2,1)
plot(t, pos_x, t, pos_y)
grid on
title('Pozicija x za v = 1 i wanted =[0.0309, 0.4755]')


subplot(4,2,2)
plot(t, pos_x2, t, pos_y2)
grid on
title('Pozicija y za v = 1 i wanted =[0.0309, 0.4755]')
...
xlabel('t(s)')
ylabel('povjerenje')
title('Povjerenje prema agentu 3 - tocan agent') 
...
xlabel('t(s)')
ylabel('povjerenje')
title('Povjerenje prema agentu 4 - tocan agent')
...
xlabel('t(s)')
ylabel('povjerenje')
title('Povjerenje prema agentu 5 - intruder k = 0.2')
